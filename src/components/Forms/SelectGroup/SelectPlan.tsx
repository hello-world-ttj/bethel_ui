...
const SelectPlan: React.FC<{ onPlanChange: (value: string) => void; selectedPlan: string }> = ({ onPlanChange, selectedPlan}) => {
  ...
  return (
    <div className="mb-4.5">
      <label className="mb-2.5 block text-black dark:text-white">Plan</label>

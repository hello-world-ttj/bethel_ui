            ...
            <ul className="mb-6 flex flex-col gap-9.5">
              ...
              <li>
                <NavLink
                  to="/magazine"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium  duration-300 ease-in-out hover:bg-[#f09443] hover:text-white dark:hover:bg-meta-4 ${
                    pathname.includes("magazine") && "bg-[#f09443] text-white"
                  }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    <path
                      ...
                      d="M3.75 4.5c0-.621.504-1.125 1.125-1.125h6.75c.621 0 1.125.504 1.125 1.125v15c0 .621-.504 1.125-1.125 1.125h-6.75A1.125 1.125 0 0 1 3.75 19.5v-15Zm10.5 0c0-.621.504-1.125 1.125-1.125h3.75A3.375 3.375 0 0 1 22.5 6.75v10.5a3.375 3.375 0 0 1-3.375 3.375h-3.75a1.125 1.125 0 0 1-1.125-1.125v-15Z"
                    />
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M6 7.5h4.5m-4.5 3h3m4.5-3h4.5m-4.5 3h3"
                    />
                  </svg>
                  Magazine
                </NavLink>
